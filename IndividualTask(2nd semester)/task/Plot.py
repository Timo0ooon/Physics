...
class Plot:
    def __init__(self, numerical_solution: NumericalSolution, analytical_solution: AnalyticalSolution):
    ...
    def plot_depth_versus_time(self) -> None:
        ...
        ax.set_title("Зависимость глубины от времени c учетом сопротивления воды")
